    ...
    <div className="max-w-xl text-center">
      ...
      <div className="md:mx-16 mt-6 md:mt-16 md:flex">
        <div className="min-w-full max-w-3xl mx-16 md:mt-8 mt-16">
          ...
          <p className="text-lg mt-8 max-w-1/2">
            ...
            ability to write a basic blog app with React, Node and other JS
            technologies.
          </p>
        </div>
      ...
      <div className="md:flex md:mx-16 md:mx-auto">
        ...
        <div className="mx-12 md:mr-24 md:mx-0 py-8 min-w-full max-w-3xl">
          ...
          <p className="text-lg mt-8 md:max-w-lg md:min-w-full">
            We don't really do much in the way of providing meaningful
            readership with our blog posts considering they are mockups and will
            likely only ever have Lorem Ipsum font within them.
          </p>
        </div>
      </div>
    </div>
